// 1512064_Explorer.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "1512064_Explorer.h"
#include <commctrl.h>
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_1512064_MYEXPLORER, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_1512064_MYEXPLORER));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_1512064_MYEXPLORER);
